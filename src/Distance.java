...
public class Distance {
    ...
    public static void main(String[]args) {
        ...
        System.out.println("Please enter the first X coordinate: "); //gets the users first x cordinate
        ...
        double slope_of_the_points = ((Math.pow(second_y_coordinate,2))-(Math.pow(first_y_coordinate,2)/
                (Math.pow(second_x_coordinate,2))-(Math.pow(first_x_coordinate,2)))); /*solves for slope of two points
               using this equation of  (Y(2)^2 - Y(1)^2)/(X(2)^2 - X(1)^2) */

        System.out.println("The difference between" + "("+first_x_coordinate +", " + first_y_coordinate + ") and ("+
                second_x_coordinate + ", " + second_y_coordinate + ") is " +  slope_of_the_points);
