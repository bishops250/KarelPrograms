    ...
    public static void main(String[] args) {
       ...
       and last name */
        ...
        String mid_first = ((user_first_name.substring(0, user_first_name.length() / 2)) +
                (user_last_name.substring(user_last_name.length() / 2)));

        String mid_last = ((user_last_name.substring(0, user_last_name.length() / 2)) +
                (user_first_name.substring(user_first_name.length() / 2)));
        ...
        System.out.println(index_firstname_last_letter);
        System.out.println(index_lastname_last_latter);
